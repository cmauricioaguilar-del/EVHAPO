...
async function tournAnalyze() {
  ...
  resultEl.innerHTML = `
    <div class="card" style="text-align:center;padding:48px 20px">
      ...
      <p style="color:#64748b;font-size:0.78rem;margin-top:10px;font-style:italic;font-weight:700">
        ${_isEN2
          ? '⚠ This analysis is generated by artificial intelligence and may contain inaccuracies. The identified strengths and mistakes are indicative — it is the player\'s responsibility to validate, study and cross-reference them before applying changes to their game.'
          : _isPT2
          ? '⚠ Esta análise é gerada por inteligência artificial e pode conter imprecisões. Os acertos e erros identificados são orientativos — é responsabilidade do jogador validá-los, estudá-los e confrontá-los com outras fontes antes de aplicar mudanças ao seu jogo.'
          : '⚠ Este análisis es generado por inteligencia artificial y puede contener imprecisiones. Los aciertos y errores identificados son orientativos — es responsabilidad del jugador validarlos, estudiarlos y contrastarlos con otras fuentes antes de aplicar cambios a su juego.'}
      </p>
